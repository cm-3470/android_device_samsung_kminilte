...
*/
    ...
    {RIL_UNSOL_STK_CALL_CONTROL_RESULT, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_DUN_CALL_STATUS, responseInts, WAKE_PARTIAL},
    {11005, responseString, WAKE_PARTIAL},
    {11006, responseString, WAKE_PARTIAL},
    {RIL_UNSOL_O2_HOME_ZONE_INFO, responseRaw, WAKE_PARTIAL},
    {RIL_UNSOL_DEVICE_READY_NOTI, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_GPS_NOTI, responseInts, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_SAP, responseInts, WAKE_PARTIAL},
    {11014, responseString, WAKE_PARTIAL},
    {RIL_UNSOL_SIM_SMS_STORAGE_AVAILALE, responseInts, WAKE_PARTIAL},
    ...
    {RIL_UNSOL_UART, responseInts, WAKE_PARTIAL},
